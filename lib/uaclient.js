...
function req_folder_list(self) {
    self.request('folder_list', {searchtype: 2});
}
...
function UAClient() {
    ...
    self.addListener("reply_user_login", function(){
        setTimeout(function(){ req_user_list(self); }, 5000); // avoid parsing troubles
        setTimeout(function(){ req_folder_list(self) }, 5100); // also
    });
    // ... then every 5 minutes after this
    setInterval(function(){req_user_list(self)}, 300000);
    setInterval(function(){req_folder_list(self)}, 300000);
